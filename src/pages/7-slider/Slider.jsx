...
function Slider () {
    ...
    return(
        <>
            <section className='w-[90vw] max-w-[1170px] my-20 mx-auto'>
                ...
                <div className='mt-16 mx-auto w-[80vw] h-[450px] max-w-[800px] text-center flex overflow-hidden relative'>
                    {people.map((person, personIndex) => {
                        ...
                        return (
                            <article
                                className={className}
                                key={person.id}>
                                <img className='mb-4 rounded-full w-40 h-40 object-cover shadow-md border-4 border-solid border-gray-900' alt={person.name} src={person.image}/>
                    ...
                    <button className='absolute left-0 top-52 -translate-y-1/2 bg-gray-700 hover:bg-emerald-500 text-white w-5 h-5 md:w-8 md:h-8 md:text-xl grid place-items-center border-transparent rounded text-sm transition cursor-pointer' onClick={previousHandler}>
                        <FiChevronLeft></FiChevronLeft>
                    </button>
                    <button className='absolute right-0 top-52 -translate-y-1/2 bg-gray-700 hover:bg-emerald-500 text-white w-5 h-5 md:w-8 md:h-8 md:text-xl grid place-items-center border-transparent rounded text-sm transition cursor-pointer' onClick={nextHandler}>
