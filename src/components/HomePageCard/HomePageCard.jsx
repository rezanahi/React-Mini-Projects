...
function HomePageCard({ level, name, image, url, github}) {
  return (
    <div className="overflow-hidden w-full h-auto flex flex-col gap-4 border border-1 border-stone-500 rounded-md p-2 shadow-md bg-sto">
      ...
      <footer className="pt-2 border-t border-stone-500 flex justify-between items-center gap-2">
        <Link to={github} className="py-1 px-2 grow rounded-md bg-stone-800  text-stone-400 font-extralight flex justify-between items-center">
          مشاهده کد
